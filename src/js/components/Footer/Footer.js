			...
			<footer className="footer pb-2">
				<div className="container wide">
					<div className="grid-flex align-center">
						<div className="col no-grow"><p className="small-caps my-2">Queens, New York</p></div>
						<div className="col no-grow"><p className="small-caps"><a className="my-2" href="#">Work Archive</a></p></div>
